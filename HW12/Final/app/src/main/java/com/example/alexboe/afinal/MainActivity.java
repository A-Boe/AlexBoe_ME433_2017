package com.example.alexboe.afinal;
...
import com.example.alex.hw12mk2.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextViewf = (TextView) findViewById(R.id.cameraStatus);
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        if (c != null) {
            ...
            for (int jj = 1; jj < bmp.getHeight(); jj = jj + 5) {
                int startY = jj; // which row in the bitmap to analyze to read
